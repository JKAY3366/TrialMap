...
url = "https://raw.githubusercontent.com/JKAY3366/TrialMap/main/HDIforGeojson.csv" # Make sure the url is the raw version of the file on GitHub
...
stateshape = gpd.read_file("india_telengana.geojson")
stateshape
...
def json_data(selectedYear):
    ...
    merged = stateshape.merge(df_yr, on='NAME_1')
